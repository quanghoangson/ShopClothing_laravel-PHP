...
<head>
    ...
    <title>Order Notification | Sondeptrai@</title>
</head>
    ...
    <div class="container" style="background-color: #e7eff8; width: 600px; margin: auto;">
        <div class="col-12 mx-auto" style="width: 580px;  margin: 0 auto;">
                    ...
                    <div class="row pl-3 py-2" style="background-color: #fff; padding: 10px 20px 10px 20px;">
                        <table class="table table-sm table-hover"
                            ...
                            @foreach($order->orderDetails as $orderItem)
                                <tr>
                                    <td style="border-top: 1p   x solid #dee2e6; padding: 5px 0;">
                                        {{ $orderItem->product->name . ' (x' . $orderItem->qty . ')'}}
            ...
            <div class="row mt-2 mb-4" style="margin-top: 15px; margin-bottom: 25px;">
                <div class="container-fluid">
                    <div class="row pl-3 py-2" style="background-color: #f4f8fd; padding: 10px 0 10px 20px;">
                        <b style="color: #00509d; font-size: 18px;">THÔNG TIN CẦN LƯU Ý</b>
                    </div>
                    <div class="row pl-3 py-2" style="background-color: #fff; padding: 10px 20px;">
                        <p>Thông tin thêm thông tin bạn có thể kiểm tra sự xuất hiện của sản phẩm (thương hiệu, mô hình, màu sắc, số lượng, ...)
                            trước khi thanh toán và có thể từ chối nhận hàng nếu không hài lòng.
                            Vui lòng không kích hoạt một thiết bị điện tử điện hoặc thử sản phẩm</p>

                        <p>Nếu sản phẩm có dấu hiệu thiệt hại / bị hỏng hoặc không khớp thông tin trên trang web,
                             vui lòng liên hệ với cửa hàng trong vòng 48 giờ kể từ khi nhận được hỗ trợ.</p>

                        <p>Vui lòng giữ hóa đơn, hộp sản phẩm và thẻ bảo hành (nếu có) để trả lại hoặc bảo hành khi cần</p>

                        <p>ạn có thể tham khảo trang trung tâm trợ giúp hoặc liên hệ với cửa hàng bằng cách để lại tin nhắn tại trang liên hệ hoặc gửi thư tại đây.
                             Đường dây nóng 0971 213 792 (8:00am- 9:00pm cả thứ bảy và chủ nhật).</p>

                        <b>SONSHOP thank you.</b>
                    </div>
                </div>
            </div>
